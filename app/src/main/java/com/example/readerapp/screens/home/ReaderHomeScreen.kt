...
import com.example.readerapp.components.FABContext
...
fun HomeContent(navController: NavController, viewModel: HomeScreenViewModel) {
    ...
    if (!viewModel.data.value.data.isNullOrEmpty()) {
        listOfBooks = viewModel.data.value.data!!.toList()
            .filter { mBook -> mBook.userId == currentUser?.uid.toString() }
        Log.d("Books", "HomeContent: ${listOfBooks.toString()}")
    }

//    val listOfBooks = listOf(
//        MBook(id = "test1", title = "Hello", authors = "All of us", notes = null),
//        MBook(id = "test2", title = "Hello..", authors = "All of us", notes = null),
//        MBook(id = "test3", title = "Hello...", authors = "All of us", notes = null),
//        MBook(id = "test4", title = "Hello....", authors = "All of us", notes = null),
//        MBook(id = "test5", title = "Hello.....", authors = "All of us", notes = null),
//        MBook(id = "test6", title = "Hello......", authors = "All of us", notes = null),
//    )
    val email = FirebaseAuth.getInstance().currentUser?.email
    val currentUserName =
        if (email?.isNotEmpty() == true) email.split(
            "@"
        )[0] else "N/A"
