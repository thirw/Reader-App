...
@Composable
fun ShowBookDetails(bookInfo: Resource<Item>, navController: NavController, function: () -> Unit) {
        ...
        dbCollection.add(book).addOnSuccessListener { documentRef ->
            ...
            dbCollection.document(documentRef.id)
                ...
                .addOnCompleteListener { task ->
                    ...
                    Log.w("ERROR", "saveToFirebase: Error updateing doc", it, )
                }
        }
    } else {
